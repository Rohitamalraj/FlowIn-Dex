...
import { Search, Lock, Loader2, CheckCircle2, Wallet, Plus, Minus, X, Shuffle, Zap } from "lucide-react"
                ...
                <div className="rounded-2xl border border-border bg-card p-6 space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-sm font-semibold text-foreground">
                      Build Address B Index (same flow builder as Create Duel)
                    </span>
                  </div>
                  ...
                  <div className="rounded-2xl border border-border bg-card px-5 py-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex flex-wrap gap-3">
                        ...
                        {nodes.length === 0 && (
                          <span className="font-mono text-xs text-muted-foreground/50">No assets added yet</span>
                        )}
                      </div>
